...
- 国内仓库
  - AMD64镜像
    ```bash
    swr.cn-north-4.myhuaweicloud.com/firfe/frps:0.69.1
    ```
  - ARM64镜像
    ```bash
    swr.cn-north-4.myhuaweicloud.com/firfe/frps:0.69.1-arm64
    ```
- DockerHub仓库
  - AMD64镜像
    ```bash
...
- 国内仓库
  - AMD64镜像
    ```bash
    swr.cn-north-4.myhuaweicloud.com/firfe/frpc:0.69.1
    ```
  - ARM64镜像
    ```bash
    swr.cn-north-4.myhuaweicloud.com/firfe/frpc:0.69.1-arm64
    ```
- DockerHub仓库
  - AMD64镜像
    ```bash
